...
namespace WebAppSastiServices.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        //public PartialViewResult pvServiceModal(string ServiceTypeID)
        //{
        //    ViewBag.TimeRange = new SelectList(db.STPPrefferedTimes, "ID", "TimeRange");
        //    ViewBag.PowerRange = new SelectList(db.STPUnits, "ID", "Options");
        //    ViewBag.Dependent = new SelectList(db.STPFuelTypes, "ID", "Options");

        //    return PartialView();
        //}

        //public JsonResult ReturnServiceRequirment(int ServiceTypID)
        //{
        //    db.Configuration.ProxyCreationEnabled = false;

        //    var PowerRange = (from d in db.STPUnits
        //                      where d.STPServiceTypeID == ServiceTypID
        //                      select d).ToList();

        //    var Dependent = (from d in db.STPFuelTypes
        //                     where d.STPServiceTypeID == ServiceTypID
        //                     select d).ToList();

        //    FormFields objFields = new FormFields();
        //    objFields.DependentsList = Dependent;
        //    objFields.PowerUnitLIst = PowerRange;
        ...
        //{
        //    public List<STPUnit> PowerUnitLIst { get; set; }

        //    public List<STPFuelType> DependentsList { get; set; }
        //}

        //[HttpPost]
        //public PartialViewResult pvServiceModal(string Name,
        //                                        string Contact,
        //                                        string Address,
        //                                        string Description,
        //                                        DateTime PrefferedDate,
        //                                        int TimeRange,
        //                                        int cmbDependent,
        //                                        int cmbPowerRange,
        //                                        int ServiceTypeID
        ...
        //    STPOrder o = new STPOrder()
        //    {
        //        Name = Name,
        //        Contact = Contact,
        //        Address = Address,
        //        Description = Description,
        //        PrefferedDate = PrefferedDate.Date,
        //        PrefferedTimeID = TimeRange,
        //        STPFuelTypeID = cmbDependent,
        //        STPUnitsID = cmbPowerRange,
        //        STPServiceTypeID = ServiceTypeID,
        //        STPStatusID=4 
